...
def img_normalization(im_input, m0 = 0.0, var0 = 1.0):
    ...
    #lamda function for apply, but easier to comprehend
    #def compare(x):
...
#atan2 function is included in pytorch, torch.atan2
...
def conv_bn_prelu(bottom, w_size, strides=(1,1), dilation_rate=(1,1)):
